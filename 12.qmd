...
2.  **Predicción de una nueva ubicación:** El kriging se aplica sobre los scores obtenidos. Se predicen los scores de la nueva ubicación $s_{0}$ para construir la función predicha $\hat{X}(s_{0}, t)$ como una combinación de las bases funcionales ponderadas por los scores predichos:
